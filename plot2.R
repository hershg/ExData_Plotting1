...
## Actual function to create Plot 2
Plot2 <- function() {
  plot_2_data <- GetData() ## Get the desired data using above function
  ...
  plot(x = plot_2_data$DateTime, y = plot_2_data$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
  dev.off() ## Close
}

## Execute plotting function for Plot 2
Plot2()